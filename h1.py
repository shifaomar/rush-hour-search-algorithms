#Best-first search solver using h1, 
#estimates the remaining cost as the no. of moves the red car needs to reach exit, 
#ignores blocking vehicles.
...
def h1(initial_state, heuristic, max_nodes=None):
    heap = []
...
def main():
    ...
    solution, nodes_visited = h1(state, h1_distance)
